...
public class ConfigurationTest
{
	...
	assertEquals (Configuration.showDateRange (),
		      "2017-01-19 05:00:00 - 2017-01-23 12:00:00");
	...
	assertEquals (Configuration.getTask ("task1").toString (),
		      "task1\nsome title for task 1\nhttp://somewhere.fr\nA terrific task");
	assertEquals (Configuration.getTask ("task2").toString (),
